...
function ribbon_lite_scripts() {
	...
	$custom_css = "
        ...
        #tabber .inside li .meta b,footer .widget li a:hover,.fn a,.reply a,#tabber .inside li div.info .entry-title a:hover, #navigation ul ul a:hover, a:hover, .sidebar.c-4-12 .textwidget a, #site-footer .textwidget a, #commentform a, #tabber .inside li a, .copyrights a:hover, a, .sidebar.c-4-12 a:hover, .top a:hover, footer .tagcloud a:hover { color: $ribbon_lite_color_scheme; }
...
if ( ! function_exists( 'ribbon_lite_archive_post' ) ) {
    ...
    function ribbon_lite_archive_post( $layout = '' ) { 
        ...
        <article class="post excerpt">
            <div class="post-date-ribbon"><div class="corner"></div><div class="corner-title"><?php the_category(', '); ?></div></div>
            <header>                        
                <h2 class="title">
